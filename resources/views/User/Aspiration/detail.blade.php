      ...
      <div class="col-md-6 mb-2">
        <div class="card">
            <div class="card-body">
                ...
                <h6 class="card-title">Nama User   : {{$aspiration["username"]}}</h6>
              ...
              <a href="{{url('/user/edit-aspiration/' . $aspiration["aspiration_id"])}}" class="btn btn-warning">Edit Aspirasi</a>

              
              <form action="{{url('/user/aspiration/'.$aspiration["aspiration_id"].'/delete')}}" method="POST" >
                @csrf
                @method('DELETE')
